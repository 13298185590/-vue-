<template>
    <div class="profile">
      ...
      <div class="headImg">
        <div class="img">
          <img :src="userImg" @click="goProfileInfo" alt="">
        </div>
    ...
    <div class='application'>
      <div @click='$router.push("/home")'><img src="https://s10.mogucdn.com/mlcdn/c45406/190815_7a9da7lh4a96lb1fl6b4gb854f3ji_75x75.png"
             alt="">
        <p>主页</p>
      </div>
      ...
      <div @click='$router.push("/centerCollect")'><img src="https://s10.mogucdn.com/mlcdn/c45406/190815_31g4a5ebc8bj2f85cj4li8df89aab_75x75.png"
             alt="">
        <p>收藏</p>
      </div>
    ...
    <div class="order">
      ...
      <div class="order-bottom">
        <div v-for="(item,index) in orderInfo" :key="index" @click="goProfileOrder(index)">
...
import { getuserinfo,getuserorder } from '../../api/adminapi'
export default {
  data(){
    return{
      orderInfo: [
  ...
  methods:{
    ...
    goProfileOrder(index){
      //去订单列表
      this.$router.push({path:'/centerOrder',query:{data:this.orderList,index}})
    },
    goAdress(){
      //去收货地址页面
