<template>
  <div class="order">
    ...
    <!-- addAdress -->
    <div class="addAdress" v-show="isAddAdress">
      ...
      <div v-show="isAdressList" class="adressList">
        <div v-for="(item,index) in adressList" :key="index" :class='{choose:index===choseAdress}'>
...
import {getuseradress,deadress, addadress, edadress} from '../../api/adminapi'
export default {
  created(){
  ...
  methods:{
    ...
    async deleteAdress(index){
      const result =await deadress(this.$qs.stringify({index}))
